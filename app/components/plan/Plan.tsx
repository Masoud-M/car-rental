...
const Plan = () => {
  return (
    <div>
      <div className="h-screen px-4 lg:px-0 lg:w-[65%] mx-auto">
        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-center justify-items-center text-center my-12">
